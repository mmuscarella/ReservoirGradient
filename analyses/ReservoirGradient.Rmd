...
OTUsREL <- decostand(OTUs, method = "hellinger")
...
lake %>% 
  ggplot(aes(x = distance, y = S.obs, color = molecule)) + 
  geom_point() +
...
UL.bray      <- sqrt(2) - as.matrix(vegdist(OTUsREL, method="euclidean"))
...
UL.sim %>% 
  ggplot(aes(x = distance, y = bray.mean, color = molecule)) +
  geom_point() + 
...
UL.bray2      <- sqrt(2) - as.matrix(vegdist(OTUsREL, method="euclidean"))
...
UL.sim2 %>% 
  ...
  geom_point() + 
  geom_smooth(method = "lm") + 
  labs(y = "mean hellinger distance of DNA")

UL.sim2 %>% 
  ggplot(aes(x = distance, y = RNA, color = molecule)) +
  geom_point() + 
  geom_smooth(method = "lm") + 
  labs(y = "mean hellinger distance of RNA")
...
ggplot(metab, aes(x = dist, y = BP)) + 
  geom_point() + 
  geom_smooth(method = "lm", formula = y ~ x + I(x^2), color = "black")
ggplot(metab, aes(x = dist, y = BR)) + 
  geom_point() + 
  geom_smooth(method = "lm", formula = y ~ x, color = "black")
ggplot(metab, aes(x = dist, y = BGE)) + 
  geom_point() + 
  geom_smooth(method = "lm", formula = y ~ x + I(x^2), color = "black")
```
