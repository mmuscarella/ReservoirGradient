...
## Figu S1: Map of University Lake

## Megan: please remove "nutrient maps" and put them in an "extra analylses" file
## Megan: Change Bloomington symbol to black/white color, maybe star symbol
```{r}
...
## Megan: fix white spots, etc. Are there other variables we could plot?
```{r }
