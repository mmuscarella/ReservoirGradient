...
mtext(expression(paste('Total Phosphorus (mg P L'^-1*')')), side = 2, line = 4, cex = 1)
...
mtext(expression(paste('Chlorophyll A (mg L'^-1*')')), side = 2, line = 4, cex = 1)


#Dissolved Oxygen
plot(env.dat$dist.dam, env.dat$chla, 
     ylab = "", xlab = "", cex.lab = 2, las = 1,
     ylim = c(0,30), xlim = c(-15, 400),
     pch = 22, cex = 2, bg = "white", col = "black", lwd = 2,
     yaxt = "n", xaxt = "n")
...
terr.rich.log <- log(terr.rich)
terr.REL.log <- log(terr.REL)
...
plot(terr.rich ~ design.dna$distance, col= "black", pch=22, las = 1,
     xlim = c(400, 0), ylim = c(20, 1800), cex = 1.5, log = "y", 
     xlab="", ylab="", xaxt="n")
...
plot(terr.REL ~ design.dna$distance, col= "black", pch=22, las = 1,
     xlim = c(400, 0), ylim = c(0.005, 0.18), cex = 1.5, log = "y",
     xlab="", ylab="")
