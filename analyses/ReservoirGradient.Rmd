...
OTU.tax[OTU.tax$OTU %in% colnames(in.lake.core),]

OTU.tax[OTU.tax$OTU %in% colnames(in.lake.core.from.soils),]
OTU.tax[OTU.tax$OTU %in% colnames(in.lake.core.not.soils),]
